...
- [Module](https://aka.ms/mslearn-prepare-ai-dev)
...
- [Module](https://aka.ms/mslearn-ai-models)
...
- [Module](https://aka.ms/mslearn-ai-foundry-rag)
...
- [Module](https://aka.ms/mslearn-ai-fine-tune)
...
- [Module](https://aka.ms/mslearn-responsible-ai)
...
- [Module](https://aka.ms/mslearn-ai-evaluation)
...
<B>Labs</B>
- [Lab-01 - Prepare for an AI development project](https://microsoftlearning.github.io/mslearn-ai-studio/Instructions/01-Explore-ai-studio.html)
- [Lab-02 - Choose and deploy a language model](https://microsoftlearning.github.io/mslearn-ai-studio/Instructions/02-Explore-model-catalog.html)
- [Lab-02A - Create a generative AI chat app](https://microsoftlearning.github.io/mslearn-ai-studio/Instructions/02a-AI-foundry-sdk.html)
- [Lab-03 - Use a prompt flow to manage conversation in a chat app](https://microsoftlearning.github.io/mslearn-ai-studio/Instructions/03-Use-prompt-flow-chat.html)
- [Lab-04 - Create a generative AI app that uses your own data](https://microsoftlearning.github.io/mslearn-ai-studio/Instructions/04-Use-own-data.html)
- [Lab-05 - Fine-tune a language model](https://microsoftlearning.github.io/mslearn-ai-studio/Instructions/05-Finetune-model.html)
- [Lab-06 - Apply content filters to prevent the output of harmful content](https://microsoftlearning.github.io/mslearn-ai-studio/Instructions/06-Explore-content-filters.html)
- [Lab-07 - Evaluate generative AI model performance](https://microsoftlearning.github.io/mslearn-ai-studio/Instructions/07-Evaluate-prompt-flow.html)
