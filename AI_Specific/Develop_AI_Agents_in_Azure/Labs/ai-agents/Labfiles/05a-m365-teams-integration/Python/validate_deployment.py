...
class DeploymentValidator:
    ...
    def get_azd_env_values(self):
        ...
        try:
            ...
            # Extract key values
            self.endpoint = env_vars.get("AZUREAI_PROJECT_ENDPOINT") or env_vars.get(
                "PROJECT_ENDPOINT"
            )
            self.project_name = env_vars.get("AZUREAI_PROJECT_NAME") or env_vars.get(
                "PROJECT_NAME"
            )
            self.resource_group = env_vars.get("AZURE_RESOURCE_GROUP") or env_vars.get(
                "RESOURCE_GROUP"
            )
