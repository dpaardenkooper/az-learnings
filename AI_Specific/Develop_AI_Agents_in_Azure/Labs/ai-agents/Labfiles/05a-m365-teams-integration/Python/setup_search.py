...
class SearchSetup:
    ...
    def create_search_service(self):
        ...
        try:
            ...
            self.search_endpoint = (
                f"https://{self.search_service_name}.search.windows.net"
            )
    ...
    def create_search_index(self):
        ...
        try:
            ...
            index_client = SearchIndexClient(
                endpoint=self.search_endpoint, credential=credential
            )
    ...
    def test_search(self):
        ...
        try:
            ...
            # Simple search
            results = search_client.search(search_text="remote work", top=3)
